...
include { CLIP_DISCORDANT_CUTRUN } from '../modules/cutrun/clip_discordant'
...
workflow CUTRUN {
    ...
    cutrun_clip=CLIP_DISCORDANT_CUTRUN(cutrun_sorting.bam)
    cutrun_merge=MERGE_DISCORDANT_CUTRUN(cutrun_clip.bam, cutrun_sorting.bam)
